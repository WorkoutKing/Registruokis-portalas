        ...
        <div class="form-group mb-3">
            <div class="custom-file">
                <input type="file" name="files[]" id="files" multiple accept=".jpg,.jpeg,.png,.pdf"
                    class="custom-file-input shadow-sm" onchange="updateFileName()">
                <label class="custom-file-label" for="files" id="file-label">Pasirinkti failą</label>
            </div>
            <small class="form-text text-muted" id="file-count">Galimi failų formatai: JPEG, PNG, PDF. Maksimalus failo
                dydis: 2MB.</small>
        </div>
