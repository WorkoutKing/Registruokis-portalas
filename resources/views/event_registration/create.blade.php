    ...
    <div class="container">
        ...
        <form action="{{ route('event_registration.store', ['event' => $event->id]) }}" method="POST" class="form_event_reg">
            ...
            <div class="form-floating mb-3">
                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ auth()->check() ? auth()->user()->name : '' }}" required>
            ...
            <div class="form-floating mb-3">
                <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="{{ auth()->check() ? auth()->user()->surname : '' }}" required>
            ...
            <div class="form-floating mb-3">
                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ auth()->check() ? auth()->user()->phone : '' }}">
